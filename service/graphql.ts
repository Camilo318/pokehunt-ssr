...
export type Date_Filter_Operators = {
  _between?: InputMaybe<
    Array<InputMaybe<Scalars['GraphQLStringOrFloat']>>
  >
...
export type PokemonFieldsFragment = {
  ...
  attack?: number | null
  defense?: number | null
  image?: { __typename?: 'directus_files'; id: string } | null
}
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'pokemon_aggregated' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                {
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'pokemon_by_id' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'id' },
...
>
export const SearchPokemonsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'searchPokemons' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
